...
/**
 * @brief      Generic framebuffer for visualizing images Written by Josh Bainbridge MSc 2015
 * 
...
public:
   ...
   */
  GLFWwindow* init(const size_t _resx, const size_t _resy, void* _input_data = NULL);
   ...
   */
  void image(const unsigned char* _image, const size_t _resx, const size_t _resy);
